...
<div class="card">
  <h1>Recadrer un asset</h1>

<form method="post" action="../api/assets_crop.php">
  <label>Chemin</label>
  <input type="text" name="path" required>
  <label>Crop JSON (x,y,w,h)</label>
  <input type="text" name="crop" placeholder='{{"x":0,"y":0,"w":100,"h":100}}' required>
  <?= csrf_field() ?>
  <button class="btn" type="submit">Recadrer</button>
</form>
